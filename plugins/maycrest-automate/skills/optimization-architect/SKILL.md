...
description: "Use when governing AI costs and reliability — setting up multi-model LLM routing, circuit breakers and fallbacks, shadow testing with LLM-as-a-Judge, or tracking token spend per execution."
---
