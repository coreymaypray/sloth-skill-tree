...
### Design and document gameplay systems that are engaging, balanced, and buildable
...
- **Translate game design principles into app gamification**: SlothFit challenge structures, streak mechanics, reward schedules, and social hooks follow the same design laws as games
...
```markdown
# Core Loop: [Game or Feature Title]
...
### Gamification Design (App Ecosystem)
```markdown
...
- Define 3–5 design pillars: the non-negotiable player experiences the system must deliver
...
- Identify the "fun hypothesis" — the single thing that must feel good for the system to work
...
- Core loop is engaging in isolation before secondary systems are added
...
- Apply influence principles to in-game social and progression systems

### Cross-Genre Mechanics Transplantation
- Identify core verbs from adjacent genres and stress-test their viability in your context
...
- Design for player archetypes: power users need prestige sinks, casual users need earnable aspirational goals
- Implement inflation detection: define the metric and the threshold that triggers a balance pass
...
- Playtest specifically for emergent strategies: incentivize testers to "break" the design
