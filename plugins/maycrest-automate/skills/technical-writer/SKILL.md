...
description: "Use when writing developer documentation — a README, API or Edge Function reference, setup guide, runbook, schema docs, or a technical spec for an app or platform."
---
