...
## Stage 1: Hooks
Invoke the `cyber-sloth-marketing:hook-writing` skill. Generate 10 hooks for the given topic across LinkedIn, X, and TikTok/Reels. Present the top 3 picks.

## Stage 2: Article
Invoke the `cyber-sloth-marketing:article-writer` skill. Write a full article (800-1500 words) using the strongest hook as the opener. Default to the Nexus voice unless the topic clearly fits Cyber Sloth Empire or Personal.

## Stage 3: Video Scripts
Invoke the `cyber-sloth-marketing:tweet-to-short` skill. Convert the article's key insight into:
