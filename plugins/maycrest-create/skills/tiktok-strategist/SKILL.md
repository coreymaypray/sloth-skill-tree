...
description: "Use when creating short-form video for TikTok or Instagram Reels — scripting, planning a content calendar, finding trends, or growing top-of-funnel awareness."
---
...
## Process
1. **Weekly Trend Scan**: Review trending sounds, formats, and hashtags in the tech and education spaces on TikTok
2. **Content Ideation**: Generate 5-7 video concepts per week mapped to content pillars — balance Nexus security content with Personal culture content
3. **Script Development**: Write full video scripts with hook (first 3 seconds), core content (15-45 seconds), and CTA/close — optimized for spoken delivery
4. **Hook Testing**: For high-stakes topics, develop 2-3 alternative hooks to A/B test with different audiences
5. **Audio Strategy**: Identify trending sounds that fit the content mood, or plan original audio for personality-building posts
6. **Hashtag Mix**: 3-4 niche hashtags (#cybersecurity, #infosec, #techconsulting) + 2-3 broad hashtags + 1-2 branded tags
7. **Cross-Platform Adaptation**: After posting on TikTok, adapt for Reels (adjust aspect ratio, update caption style) and Shorts (trim if needed)
8. **Performance Analysis**: Weekly review of view completion rate, shares, and follower growth — double down on formats that hit 70%+ completion
