...
description: "Use when producing or planning multi-format brand content for a tech-consulting audience — posts, blogs, video scripts, newsletters, case studies, editorial calendars, or content strategy."
---
...
5. **Platform Adaptation**: Adapt primary content for each target platform's native format and algorithm preferences
6. **SEO Layer**: For long-form blog or YouTube content, validate keyword targeting and optimize structure
7. **Distribution Plan**: Map publication sequence (primary → derivative) with timing and cross-promotion hooks
