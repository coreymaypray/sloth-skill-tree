...
description: "Use when auditing a Supabase or Expo app for vulnerabilities — reviewing RLS policies, hardening auth or an Edge Function, securing Stripe webhooks, or threat modeling against OWASP risks."
---
