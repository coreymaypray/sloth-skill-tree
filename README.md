...
The command center. This plugin contains the primary workflow skills, 23 slash commands, voice personas, and session hooks that power the entire Cyber Sloth Empire. Everything flows through here.
...
| **ux-architect** | Information architecture and technical UX — navigation structures, user flows, screen flows, and layout foundations. |
| **ux-researcher** | User research and validation — usability testing, interviews, persona development, journey mapping, and pain point identification. |
| **visual-storyteller** | Visual narrative design — infographics, storyboards, campaign visuals, social content, and data visualization storytelling. |
| **whimsy-injector** | Injects personality and delight — microcopy, error messages, empty states, Easter eggs, loading animations, and fun UI moments. |
...
| Skill | What It Does |
|-------|-------------|
| **game-audio** | Sound design and audio engineering — FMOD, Wwise, adaptive music systems, spatial audio, SFX creation, and audio middleware integration. |
| **game-designer** | Game mechanics and systems design — GDD writing, gameplay loops, balance tuning, gamification, progression systems, and onboarding flows. |
| **godot-developer** | Godot 4 development — GDScript, C# integration, signal-based architecture, node composition, and open-source game workflows. |
| **level-designer** | Level and map design — spatial storytelling, encounter design, pacing, blockout, progression flow, and environmental narrative. |
| **narrative-designer** | Game narrative — branching dialogue, character voice, lore building, environmental storytelling, and dialogue system architecture. |
| **technical-artist** | Shaders, VFX, and art pipelines — visual effects, LOD systems, texture compression, particle systems, and rendering optimization. |
| **unity-developer** | Unity engine — C# architecture, ScriptableObjects, MonoBehaviour patterns, performance optimization, and Unity-specific best practices. |
| **unreal-developer** | Unreal Engine 5 — Blueprints, C++, Gameplay Ability System (GAS), Nanite, Lumen, and UE5-specific architecture patterns. |
...
| Skill | What It Does |
|-------|-------------|
| **spatial-metal** | Metal GPU rendering — spatial graphics pipelines, Vision Pro renderers, compositor services, instanced drawing, and Metal shaders. |
| **terminal-integration** | Terminal emulation in spatial/native apps — SwiftTerm, ANSI rendering, VT100 implementation, SSH terminals, and spatial terminal UX. |
| **visionos-engineer** | Apple Vision Pro development — visionOS APIs, RealityKit, volumetric content, Liquid Glass, spatial widgets, WindowGroups, and ornaments. |
| **xr-architect** | Spatial UX design — 3D interface layouts, HUD design, comfort zones, depth placement, and spatial interaction patterns. |
| **xr-cockpit** | Cockpit and control panel interfaces — spatial HUDs, seated XR experiences, simulator interfaces, dashboard XR, and command centers. |
| **xr-developer** | WebXR development — A-Frame, Three.js XR, Babylon.js XR, immersive VR/AR, hand tracking, and browser-based spatial experiences. |
...
| Skill | What It Does |
|-------|-------------|
| **creative-strategist** | Ad creative and copy — RSA headlines, Facebook ad copy, Google ad copy, creative refresh strategy, and A/B test variants. |
| **paid-media-auditor** | Campaign forensics — account audits, wasted spend identification, ROI analysis, and performance review across all platforms. |
| **paid-social** | Paid social campaigns — Facebook, LinkedIn, TikTok ad setup, audience targeting, budget allocation, and platform-specific optimization. |
| **ppc-strategist** | Google Ads architecture — search campaign structure, keyword strategy, bid management, and cybersecurity/MSP-specific PPC playbooks. |
| **programmatic-buyer** | Display and programmatic advertising — Google Display Network, brand awareness campaigns, retargeting, and audience segmentation. |
| **search-query-analyst** | Search term analysis — query reports, negative keyword lists, wasted keyword identification, and cybersecurity keyword research. |
| **tracking-specialist** | Conversion tracking — GTM setup, GA4 implementation, Stripe event tracking, pixel debugging, and attribution modeling. |
...
| Skill | What It Does |
|-------|-------------|
| **behavioral-nudge** | Behavioral design for retention — gamification systems, engagement loops, push notification strategy, onboarding flow optimization, and churn reduction. |
| **feedback-synthesizer** | User feedback analysis — review synthesis, support ticket pattern detection, insight extraction, and signal-to-noise prioritization. |
| **sprint-prioritizer** | Backlog management with ICE/RICE scoring — sprint planning, feature ranking, scope cutting, and data-driven prioritization. |
| **trend-researcher** | Market intelligence — competitive analysis, emerging trend identification, market opportunity assessment, and industry signal monitoring. |
...
| Skill | What It Does |
|-------|-------------|
| **experiment-tracker** | A/B test and experiment management — hypothesis design, feature flags, test tracking, results analysis, and validation frameworks. |
| **jira-steward** | Agile delivery traceability — Jira ticket creation, branch naming, commit message standards, PR templates, and sprint workflow setup. |
| **project-shepherd** | Client communication and risk management — status reports, risk reviews, engagement management, and stakeholder updates. |
| **senior-pm** | Senior project management — project breakdown, task creation, scope definition, timeline planning, and client project coordination. |
| **studio-operations** | Solo and small-agency ops — capacity planning, tool audits, resource allocation, process audits, and bandwidth management. |
| **studio-producer** | Creative and technical production — project production, build coordination, creative direction, deliverable planning, and feature production. |

---

### cyber-sloth-support — Support & Ops Division

The operators. 6 skills for keeping the lights on and the money flowing.

| Skill | What It Does |
|-------|-------------|
| **analytics-reporter** | Business intelligence reports — revenue metrics, deployment stats, user growth, monthly KPIs, and data visualization from Supabase/Stripe. |
...
| **report-distribution** | Automated report delivery — scheduled reporting, client distribution, analytics delivery, and report pipeline management. |

---

### resume-career-coach — Global Skill

A standalone career coaching skill with 8 reference documents. Not tied to any plugin — works anywhere.

| What It Covers |
|---------------|
| Resume architecture and formatting best practices |
| Bullet point formulas (STAR, CAR, XYZ) |
| ATS optimization and keyword strategy |
| Cover letter writing frameworks |
| LinkedIn profile optimization |
| Interview preparation and practice |
| ChatGPT prompt templates for job search |
